...
class RatingControllerTest {
        ...
        void setUp() {
                ...
                appointmentResponseDTO = AppointmentResponseDTO.builder()
                                ...
                                .streetNumber(123)
                                .addressDetails("Apartamento 45")
                                .modality("ONLINE")
                                .date("2025-09-23")
                                .description("Atendimento de interpretação de Libras")
                                .status("PENDING")
        ...
        void shouldGetAllRatingsByInterpreterId() throws Exception {
                when(ratingService.getRatingsByInterpreterId(userId))
                ...
                verify(ratingService).getRatingsByInterpreterId(userId);
        }
