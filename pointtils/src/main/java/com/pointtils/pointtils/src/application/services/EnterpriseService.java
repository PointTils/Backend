...
public class EnterpriseService {
	private static final String ENTERPRISE_NOT_FOUND_MSG = "Enterprise not found";
	...
	public EnterpriseResponseDTO registerEnterprise(EnterpriseRequestDTO dto) {
		if (enterpriseRepository.existsByCnpj(dto.getCnpj())) {
			throw new DuplicateResourceException("CNPJ is duplicated");
		}
		
		if (userRepository.existsByEmail(dto.getEmail())) {
			throw new DuplicateResourceException("Email is duplicated");
		}
