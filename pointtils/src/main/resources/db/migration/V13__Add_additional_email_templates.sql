...
-- Template de Boas-Vindas (só insere se não existir)
...
-- Template de Recuperação de Senha (só insere se não existir)
INSERT INTO parameters (id, key, value)
...
-- Template de Confirmação de Agendamento (só insere se não existir)
INSERT INTO parameters (id, key, value)
...
-- Template de HTML enviado para admin após aprovação ou negação de cadastro (só insere se não existir)
INSERT INTO parameters (id, key, value)
